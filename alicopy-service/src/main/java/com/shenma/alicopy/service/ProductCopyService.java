...
import com.shenma.alicopy.util.prase.cate.IBussness;
import com.shenma.alicopy.util.prase.cate.TaobaoBussness;
import com.shenma.alicopy.util.prase.cate.TmailBussness;
...
public class ProductCopyService {
	...
	public void searchByBean(SearchVoBean bean) throws IOException, InterruptedException, IllegalAccessException, InvocationTargetException{
	...
	private void searchShopUrl(SearchVoBean bean) throws IOException,  InterruptedException{
		...
		if(element!=null)throw new BusinessException("3", "不存在该店铺");
		...
		if("1".equals(countele.text())){
			...
			throw new BusinessException("3", "不能准确找到该店铺");
		}
