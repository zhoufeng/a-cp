...
import com.shenma.alicopy.util.CustomerStringUtil;
import com.shenma.alicopy.util.OrderUtil;
import com.shenma.alicopy.util.bean.ImageVoBean;
import com.shenma.alicopy.util.exception.BusinessException;
import com.shenma.alicopy.util.exception.ErrorMessages;
import com.shenma.alicopy.util.reqlocal.ImageSaveForLocalUtil;
import com.shenma.alicopy.util.save.TaobaoSaveBean;
import com.shenma.alicopy.util.strategy.TopStrategyFactory;
import com.shenma.alicopy.util.strategy.TopToAliContext;
import com.shenma.alicopy.util.strategy.TopToAliIStrategy;
...
public class TaobaoFinalSaveService {
	...
	public Offer save(String url,String categoryId, boolean isSavaPic, MqRecordItem mqItem,Map<String,Object> selfInfo)
			throws IOException, AliReqException, InterruptedException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		// 准备数据
	 ...
	 */
	private String saveContent(Map<String, Object> selfInfo)throws IOException, AliReqException {
	 ...
	 * @throws AliReqException
	 */
	private String setDescInfo(String otherHref) throws IOException,
			AliReqException {
		TaobaoSaveBean bean = params.get();
	...
	private void setCatProperties() throws JsonParseException,
			JsonMappingException, IOException, AliReqException {
	...
	private void deal(Map<String, String> attributesMap)throws JsonParseException, JsonMappingException, IOException, AliReqException {
		TaobaoSaveBean bean = params.get();
		Offer offer = bean.getOffer();
	 ...
	 * @throws AliReqException
	 */
	private void setskuPics(Map<String, Map<String, Object>> specAttrMap) throws  AliReqException{
		TaobaoSaveBean bean=params.get();
		Map<String,Object> taobaoParmas=params.get().getParams();
		List<Map<String,Object>> taobaoskuList=(List<Map<String, Object>>) taobaoParmas.get("skuList");
	...
	@SuppressWarnings("unchecked")
	private String saveImage(String albumId, int i, String imageUrl,String prefix, String image_prefix, boolean isSavaPic)throws  AliReqException,BusinessException {
