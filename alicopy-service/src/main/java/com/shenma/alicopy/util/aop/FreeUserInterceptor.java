package com.shenma.alicopy.util.aop;
...
public class FreeUserInterceptor {
	...
	public static Integer maxCount=20;
	  //切入点要拦截的类
    @Pointcut("execution(* com.shenma.alicopy.service.AlibabafinalSaveService.save(..))")
    private void aliMethod(){} //声明一个切入点,切入点的名称其实是一个方法

    @Pointcut("execution(* com.shenma.alicopy.service.TaobaoFinalSaveService.save(..))")
