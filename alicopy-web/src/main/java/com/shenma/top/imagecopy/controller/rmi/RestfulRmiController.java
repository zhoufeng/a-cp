...
public class RestfulRmiController {
	...
	@ResponseBody
	public AliToken getToken(@RequestParam("appKey") String appKey,@RequestParam("memberId") String memberId){
		AliToken aliToken=memCachedUtil.getByAppkeyAndMemberId(appKey, memberId);
		return aliToken;
	}
