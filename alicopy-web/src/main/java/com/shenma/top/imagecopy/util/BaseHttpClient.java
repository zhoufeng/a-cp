...
public class BaseHttpClient {
	...
	public static String get(String url,Map<String,String> params,String encode){
		...
		if(params.size()>0)url=url.substring(0, url.length()-1);
	    ...
	    try {
			...
			if(result!=200){
				throw new IOException("请求远程token服务器错误");
			}
	...
	public static String getData(String res) throws JsonParseException, JsonMappingException, IOException{
	...
	public static void main(String[] args) {
		...
		String html=BaseHttpClient.get(url,new HashMap<String, String>(),"gbk");
