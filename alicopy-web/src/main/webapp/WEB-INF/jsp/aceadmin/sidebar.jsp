...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		...
		<%-- <li><a href="${URL_ROOT}/top/opt"> <i class="icon-text-width"></i>
				...
				<li><a href="${URL_ROOT}/top/imagecopy" > 
		  ...
		  <li class="open"><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu "  style="display: block; ">
				...
				<li name="item_copy_li"><a href="${URL_ROOT}/top/productcopy/all"> <i
						class="icon-double-angle-right"></i>整个店铺复制 </a></li>
			 ...
			 <li class="open"><a href="#" class="dropdown-toggle"> <i
				...
				class="arrow icon-angle-down"></b> </a>
				<ul class="submenu "  style="display: block; ">
				<li name="item_copy_li"><a href="${URL_ROOT}/top/productcopy/taobaocopy"> 
				<i class="icon-double-angle-right"></i>单个宝贝复制</a></li>
				<li name="item_copy_li"><a href="${URL_ROOT}/top/productcopy/batchtaobaocopy"> 
				<i class="icon-double-angle-right"></i>批量宝贝复制</a></li>
				 <li name="item_copy_li"><a href="${URL_ROOT}/top/productcopy/catetaobaocopy"> 
				<i class="icon-double-angle-right"></i> 整个类目复制</a></li>
				
			</ul></li>
			
			
			<li id="item_copy_li"><a href="${URL_ROOT}/top/productcopy/history"> <i
				class="icon-edit"></i> <span class="menu-text">复制历史</span> </a>
			</li>
			<li id="item_copy_li"><a href="${URL_ROOT}/litterfun/delRepIndex"> <i
				class="icon-edit"></i> <span class="menu-text">删除重复宝贝</span> </a>
			</li>
			
			<li id="item_copy_customer"><a href="${URL_ROOT}/top/productcopy/customer"> <i
				class="icon-edit"></i> <span class="menu-text">自定义复制</span> </a>
			</li>
